                              ...
                              <div className='flex w-full flex-col'>
                                <div className='content-editor has-bullet no-margin text-[15px]'>
                                  <ul>
                                    ...
                                    <li>
                                      <p>
                                        Chi phí hủy vé từ 10% – 30% giá vé tùy thuộc thời gian hủy vé so với giờ khởi
                                        hành ghi trên vé và số lượng vé cá nhân/tập thể áp dụng theo các quy định hiện
                                        hành.
                                      </p>
                                    </li>
                                    <li>
                                      <p>
                                        Quý khách khi có nhu cầu muốn thay đổi hoặc hủy vé đã thanh toán, cần liên hệ
                                        với Trung tâm tổng đài 1900 6067 hoặc quầy vé chậm nhất trước 24h so với giờ xe
                                        khởi hành được ghi trên vé, trên email hoặc tin nhắn để được hướng dẫn thêm.
                                      </p>
                                    </li>
                                  </ul>
                                </div>
                              ...
                              <div className='flex flex-col'>
                                ...
                                <div className='content-editor has-bullet no-margin text-[15px]'>
                                  <ul>
                                    ...
                                    <li>
                                      <p>
                                        Xuất trình thông tin vé được gửi qua SMS/Email/ hoặc liên hệ quầy vé để nhận
                                        thông tin vé trước khi lên xe.
                                      </p>
                                    </li>
                                    <li>
                                ...
                                <div className=''>
                                  ...
                                  <div className='content-editor has-bullet no-margin text-[15px]'>
                                    <ul>
                                      <li>
                                        <p>
                                          Trẻ em dưới 6 tuổi, cao từ 1.3m trở xuống, cân nặng dưới 30kg thì không phải
                                          mua vé.
                                        </p>
                                      </li>
                                      <li>
