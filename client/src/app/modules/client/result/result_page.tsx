        ...
        <React.Fragment>
          {updateSuccess ? (
            ...
            <h1 className='text-center'>Vui lòng check thông tin qua email </h1>
             <p className='text-center'>Hoặc vào trang tra cứu vé để check thông tin vé  <span className='p-2 text-blue-500
             '><Link to={'/check-ticket'}>Tra cứu vé</Link></span></p>
            
                <p className='text-center'><span className='inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'><Link to='/'>Về Trang chủ </Link></span></p>
