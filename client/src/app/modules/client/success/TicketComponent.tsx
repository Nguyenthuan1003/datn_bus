...
const TicketComponent = ({dataTicket,data}:any) => {
            ...
            <div className='text-justify'>
              ...
              <div className='flex ml-7'>
                ...
                <div className='flex-col font-normal text-right ml-[12px]'>
                  ...
                  <p className='w-[210px] text-gray-500'>{dataTicket?.pay_location}</p>
                </div>
              </div>
              <div className='flex ml-7'>
                <p className='font-bold text-gray-400'>Điểm xe trả</p>
                <div className='flex-col font-normal text-right ml-[12px]'>
                  {/* <strong>{dataTicket?.pickup_location}</strong> */}
                  <p className='w-[210px] text-gray-500'>{dataTicket?.pickup_location}</p>
                </div>
              </div>
